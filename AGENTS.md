...
- do not answer user-policy questions yourself; for goals, budget, Slurm/GPU
  ...
  delivery runtime caps, autonomy, trusted metrics, protected metrics, initial
  ideas, adapter/script execution surface, or submission/upload permission, stop
  and restate the question for the user;
