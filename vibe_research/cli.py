...
def bootstrap_dogfood_cmd(
    target: Path = typer.Option(Path("."), "--target", "-t"),
    profile: str = typer.Option("0.8.7-happy-path", "--profile"),
...
def bootstrap_sandbox_cmd(target: Path = typer.Option(Path("."), "--target", "-t"), profile: str = typer.Option("0.8.7-happy-path", "--profile")) -> None:
