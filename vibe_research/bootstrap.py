...
def run_dogfood(paths: VibePaths, *, profile: str = "0.8.5-happy-path", external_repo: Path | None = None, brief_file: Path | None = None, output_report: Path | None = None, dry_run: bool = False) -> dict[str, Any]:
